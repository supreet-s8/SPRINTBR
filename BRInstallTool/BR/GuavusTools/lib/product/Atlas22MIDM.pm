...
sub oozie {
	...
	push (@cmds,	
			...
			"pmx subshell oozie set dataset midm_subib attribute startOffset 43",
			"pmx subshell oozie set dataset midm_subib attribute frequency 60",
			"pmx subshell oozie set dataset midm_subib attribute endOffset 20",
			...
			"pmx subshell oozie set dataset midm_ipfix attribute startOffset 528",
			"pmx subshell oozie set dataset midm_ipfix attribute frequency 5",
			"pmx subshell oozie set dataset midm_ipfix attribute endOffset 241",
			...
			"pmx subshell oozie set dataset midm_out attribute startOffset 1",
			...
			"pmx subshell oozie set dataset midm_out attribute endOffset 1",
			"pmx subshell oozie set dataset midm_out attribute doneFile _DONE",
			"pmx subshell oozie set dataset midm_out attribute outputOffset 1",
			"pmx subshell oozie set dataset midm_out attribute timezone PST",
			...
			"pmx subshell oozie set dataset midm_enr_local attribute startOffset 1",
			"pmx subshell oozie set dataset midm_enr_local attribute timezone PST",
			"pmx subshell oozie set dataset midm_enr_local attribute endOffset 1",
			"pmx subshell oozie set dataset midm_enr_local attribute doneFile _DONE",
			"pmx subshell oozie set dataset midm_enr_local attribute outputOffset 1",
			...
			"pmx subshell oozie set dataset midm_enr_final attribute startOffset 1",
			"pmx subshell oozie set dataset midm_enr_final attribute endOffset 1",
			"pmx subshell oozie set dataset midm_enr_final attribute doneFile _DONE",
			"pmx subshell oozie set dataset midm_enr_final attribute outputOffset 1",
			...
			"pmx subshell oozie set dataset midm_enr_final attribute timezone PST",
			...
			"pmx subshell oozie set dataset midm_agg_final attribute startOffset 1",
			"pmx subshell oozie set dataset midm_agg_final attribute timezone PST",
			"pmx subshell oozie set dataset midm_agg_final attribute endOffset 1",
			"pmx subshell oozie set dataset midm_agg_final attribute doneFile _DONE",
			"pmx subshell oozie set dataset midm_agg_final attribute outputOffset 1",
			...
			"pmx subshell oozie set dataset midm_agg_local attribute startOffset 1",
			"pmx subshell oozie set dataset midm_agg_local attribute endOffset 1",
			"pmx subshell oozie set dataset midm_agg_local attribute timezone PST",
			"pmx subshell oozie set dataset midm_agg_local attribute doneFile _DONE",
			"pmx subshell oozie set dataset midm_agg_local attribute outputOffset 1",
			...
			"pmx subshell oozie set job MidmData action DataTransferAction attribute aggDataset midm_agg_final",
			"pmx subshell oozie set job MidmData action DataTransferAction attribute enrDataset midm_enr_final",
			"pmx subshell oozie set job MidmData action DataTransferAction attribute loginID admin", #<--------------LOGIN ID----------------> KEYLESS", 
			"pmx subshell oozie set job MidmData action DataTransferAction attribute maxParallelTransfer 1",
			"pmx subshell oozie set job MidmData action DataTransferAction attribute maxRetries 3",
			"pmx subshell oozie set job MidmData action DataTransferAction attribute maxScriptRetries 3",
			"pmx subshell oozie set job MidmData action DataTransferAction attribute outputPath /data/Midm/Out/", #<---------------------" #Path to which files copied to.
			"pmx subshell oozie set job MidmData action DataTransferAction attribute protocol CFI",
			"pmx subshell oozie set job MidmData action DataTransferAction attribute vzwIPAddress <---------------vzwIPAddress----------------->",
			...
			"pmx subshell oozie add dataset midm_out_inc_list",
			"pmx subshell oozie set dataset midm_out_inc_list attribute timezone PST",
			...
			"pmx subshell oozie set dataset midm_inc_list attribute timezone PST",
