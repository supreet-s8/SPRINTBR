...
sub oozie {
	...
	foreach my $job(keys %$jobs) {
		...
		push (@cmds, "pmx subshell oozie set job $job attribute jobStart 2012-07-31T01:00Z");
	...
	push (@cmds,	"pmx subshell oozie add dataset pnsa_selfipcleanup",
			...
			"pmx subshell oozie set dataset pnsa_ipportcleanup attribute startTime 2012-07-31T00:00Z",
			"pmx subshell oozie set dataset pnsa_subib attribute startTime 2012-07-31T00:00Z",
			"pmx subshell oozie set dataset pnsa_radius attribute startTime 2012-07-31T00:00Z",
			"pmx subshell oozie set dataset srcIpfixRecords attribute startTime 2012-07-31T00:00Z",
			"pmx subshell oozie set dataset destIpfixRecords attribute startTime 2012-07-31T00:00Z",
			"pmx subshell oozie set dataset srcSubscriberIB attribute startTime 2012-07-31T00:00Z",
			"pmx subshell oozie set dataset destSubscriberIB attribute startTime 2012-07-31T00:00Z",
			"pmx subshell oozie set dataset srcRadiusRecords attribute startTime 2012-07-31T00:00Z",
			"pmx subshell oozie set dataset destRadiusRecords attribute startTime 2012-07-31T00:00Z",
			"pmx subshell oozie set dataset pnsa_selfipcleanup attribute startTime 2012-07-31T01:00Z",
